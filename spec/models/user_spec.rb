...
describe User do
  ...
  it "should reject email addresses idendical up to case" do
  ...
  describe "password validations" do
    ...
    it "should rquire a matching password confirmation" do
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do 
      ...
      it "should return nil on email address with no user" do
        User.authenticate("bar@foo.comsi.comsa", @attr[:password]).should be_nil
      end
  ...
  describe "micropost associations" do
    ...
    it "should have a micrposts attribute" do
  ...
  describe "relationships" do
    ...
    it "should include the follower user in the follower array" do
      @user.follow!(@followed)
