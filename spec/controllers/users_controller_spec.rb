...
render_views
  ...
  describe "GET 'index'" do
    ...
    describe "for signed in users" do
      ...
      it "should not have delete links for nonadmins" do
        get :index
        other_user = User.all.second
  ...
  describe "PUT 'update'" do
    ...
    describe "Success" do
      before(:each) do
        @attr = { :name => "New Name", :email => "mememe@example.com", :password => "shokoman", :password_confirmation => "shokoman"}
      end
  ...
  describe "authenitcation of edit/update actions" do
    before(:each) do
      @user = FactoryGirl.create(:user)
    end
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      ...
      it "should redirect the users page" do
        delete :destroy, :id => @user
